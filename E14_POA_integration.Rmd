...
E14_POA_integration <- local({
  ...
  # find anchors between datasets using variable genes
  anchors <- FindIntegrationAnchors(object.list = E14full.list, normalization.method = "LogNormalize",anchor.features = 2000)
